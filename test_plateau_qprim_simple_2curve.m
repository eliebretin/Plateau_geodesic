...
epsilon =2/N;
  ...
  vv = VideoWriter(['test_plateau_2dcircle.avi'],'Motion JPEG AVI');
   vv.Quality = 90;
   open(vv);
...
lighting gouraud
    ...
    title(['n = ',num2str(i)]);
    name_fig = ['Test_plateau_2circle_1_',num2str(j_vec),'.eps']; 
