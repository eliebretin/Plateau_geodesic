...
epsilon =2/N;
  ...
  vv = VideoWriter(['test_plateau_2dcircle_cp.avi'],'Motion JPEG AVI');
   vv.Quality = 90;
   open(vv);
...
gamma1_1f =  @(theta) R*cos(theta)+0.5*(1 + 0*0.1*cos(4*theta)) ;
gamma1_2f = @(theta) R*sin(theta)+0.5 ;
gamma1_3f = @(theta) 0.35*(1 - 0*0.4*cos(4*theta)) ;


gamma2_1f =  @(theta) R*cos(theta)+0.5*(1 + 0*0.1*cos(4*theta)) ;
gamma2_2f = @(theta) R*sin(theta)+0.5 ;
gamma2_3f = @(theta) 0.65*(1 - 0*0.4*cos(4*theta)) ;
...
gamma3_1b = gamma2_1f(theta(1)); gamma3_2b = gamma2_2f(theta(1)); gamma3_3b = gamma2_3f(theta(1));
gamma4_1b = gamma1_1f(theta(1)); gamma4_2b = gamma1_2f(theta(1)); gamma4_3b = gamma1_3f(theta(1));
...
gamma3_1 = gamma2_1f(theta(1)); gamma3_2 = gamma2_2f(theta(1)); gamma3_3 = gamma2_3f(theta(1));
...
U = ones(N,N,N);
size(gamma1_1)
Ge1 = compute_geodesic_l_modif(U,Mreg,gamma3_1,gamma3_2,gamma3_3,gamma1_1,gamma1_2,gamma1_3,epsilon);
Ge2 = compute_geodesic_l_modif(U,Mreg,gamma4_1,gamma4_2,gamma4_3,gamma2_1,gamma2_2,gamma2_3,epsilon);
...
Ge1 = compute_geodesic_l_modif(1-4*u,Mreg,gamma3_1,gamma3_2,gamma3_3,gamma1_1,gamma1_2,gamma1_3,epsilon);
Ge2 = compute_geodesic_l_modif(1-4*u,Mreg,gamma4_1,gamma4_2,gamma4_3,gamma2_1,gamma2_2,gamma2_3,epsilon);
...
lighting gouraud
   ...
   axis([0,1,0,1,0.2,0.8])
    ...
    title(['n = ',num2str(i)]);
    name_fig = ['Test_plateau_2circle_cp_1_',num2str(j_vec),'.eps']; 
