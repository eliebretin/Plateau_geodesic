...
epsilon =2/N;
  ...
  vv = VideoWriter(['test_plateau_1curve.avi'],'Motion JPEG AVI');
   vv.Quality = 90;
   open(vv);
...
gamma_1f =  @(theta) R*cos(theta)+0.5*(1 + 0.1*cos(4*theta)) ;
gamma_2f = @(theta) R*sin(theta)+0.5 ;
gamma_3f = @(theta) 0.3*(1 - 0.4*cos(4*theta)) ;
...
gamma2_1b = gamma_1f(theta(1)); gamma2_2b = gamma_2f(theta(1)); gamma2_3b = gamma_3f(theta(1));
gamma1_1b = gamma_1f(theta); gamma1_2b = gamma_2f(theta); gamma1_3b = gamma_3f(theta);
...
gamma2_1 = gamma_1f(theta(1)); gamma2_2 = gamma_2f(theta(1)); gamma2_3 = gamma_3f(theta(1));
gamma1_1 = gamma_1f(theta); gamma1_2 = gamma_2f(theta); gamma1_3 = gamma_3f(theta);
...
U = ones(N,N,N);
size(gamma1_1)
Ge = compute_geodesic_l_modif(U,Mreg,gamma2_1,gamma2_2,gamma2_3,gamma1_1,gamma1_2,gamma1_3,epsilon);
...
Ge = compute_geodesic_l_modif(1-4*u,Mreg,gamma2_1,gamma2_2,gamma2_3,gamma1_1,gamma1_2,gamma1_3,epsilon);
...
lighting gouraud
    ...
    title(['n = ',num2str(i)]);
    name_fig = ['Test_plateau_1curve_1_',num2str(j_vec),'.eps']; 
