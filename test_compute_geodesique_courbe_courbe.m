...
gamma01_1b_f =  @(theta) R*cos(theta).*(1 + 0.2*cos(8*theta))+0.5 ;
gamma01_2b_f = @(theta)  R*sin(theta).*(1 + 0.2*cos(8*theta))+0.5 ;
gamma01_3b_f = @(theta) 0.6*theta.^0;
...
name_fig = ['Test2_gedesique_courbe_courbe_appro.eps']; 
