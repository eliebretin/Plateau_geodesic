...
epsilon =2/N;
  ...
  vv = VideoWriter(['test_plateau_2dcircle_far.avi'],'Motion JPEG AVI');
   vv.Quality = 90;
   open(vv);
...
Ge2 = compute_geodesic_l_modif(1-4*u,Mreg,gamma1_1,gamma1_2,gamma1_3,gamma2_1,gamma2_2,gamma2_3,epsilon);
Ge = max(Ge1,Ge2);
...
lighting gouraud
    ...
    title(['n = ',num2str(i)]);
    name_fig = ['Test_plateau_2circle_3_',num2str(j_vec),'.eps']; 
